package main.java.br.com.figueiredoisaac.telas;
...
public class Teste01 {
	...
	private void initialize() {
		...
		gl_abaInicio.setHorizontalGroup(
			gl_abaInicio.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_abaInicio.createSequentialGroup()
					.addGap(235)
					.addComponent(bemVindo)
					.addContainerGap(242, Short.MAX_VALUE))
		);
		gl_abaInicio.setVerticalGroup(
			gl_abaInicio.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_abaInicio.createSequentialGroup()
					.addGap(205)
					.addComponent(bemVindo)
		...
		gl_abaCadastrar.setHorizontalGroup(
			gl_abaCadastrar.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_abaCadastrar.createSequentialGroup()
					.addGap(53)
					.addGroup(gl_abaCadastrar.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_abaCadastrar.createSequentialGroup()
							.addGroup(gl_abaCadastrar.createParallelGroup(Alignment.TRAILING)
								.addComponent(valorNovoProduto)
								.addComponent(nomeNovoProduto))
							.addGap(18)
							.addGroup(gl_abaCadastrar.createParallelGroup(Alignment.LEADING, false)
								...
								.addComponent(txtNovoProduto, GroupLayout.PREFERRED_SIZE, 486, GroupLayout.PREFERRED_SIZE))))
					.addContainerGap(32, Short.MAX_VALUE))
		);
		gl_abaCadastrar.setVerticalGroup(
			gl_abaCadastrar.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_abaCadastrar.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblNewLabel_4, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_abaCadastrar.createParallelGroup(Alignment.BASELINE)
						.addComponent(nomeNovoProduto)
						.addComponent(txtNovoProduto, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
		...
		gl_abaListaProdutos.setHorizontalGroup(
			gl_abaListaProdutos.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_abaListaProdutos.createSequentialGroup()
					...
					.addGap(20))
				.addGroup(Alignment.LEADING, gl_abaListaProdutos.createSequentialGroup()
					.addGap(20)
		...
		gl_abaListaProdutos.setVerticalGroup(
			gl_abaListaProdutos.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_abaListaProdutos.createSequentialGroup()
					...
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(table, GroupLayout.PREFERRED_SIZE, 353, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(btnAtualizaListaProduto)
					.addGap(20))
		);
														...
														JLabel valorNovoProduto_1 = new JLabel("Valor");
																...
																lblNewLabel_4_1.setFont(new Font("Tahoma", Font.BOLD, 18));
																		...
																		comboBox.setModel(new DefaultComboBoxModel(new String[] { "0001", "0002", "0003", "0004" }));
																				...
																				gl_abaAtualizarProduto.setHorizontalGroup(
																					gl_abaAtualizarProduto.createParallelGroup(Alignment.LEADING)
																						...
																						.addGroup(gl_abaAtualizarProduto.createSequentialGroup()
																							...
																							.addGroup(gl_abaAtualizarProduto.createParallelGroup(Alignment.LEADING)
																								...
																								.addComponent(valorNovoProduto_1)
																								.addComponent(lblNewLabel_5))
																							.addPreferredGap(ComponentPlacement.RELATED)
																							.addGroup(gl_abaAtualizarProduto.createParallelGroup(Alignment.LEADING)
																								.addGroup(gl_abaAtualizarProduto.createSequentialGroup()
																									.addComponent(textField_1, 122, 122, 122)
																									.addGap(268))
																								...
																								.addGroup(gl_abaAtualizarProduto.createSequentialGroup()
																									...
																									.addComponent(btnNewButton_2, GroupLayout.PREFERRED_SIZE, 202, GroupLayout.PREFERRED_SIZE)))
																							.addGap(124))
																						.addGroup(gl_abaAtualizarProduto.createSequentialGroup()
																							.addGap(56)
																							.addGroup(gl_abaAtualizarProduto.createParallelGroup(Alignment.LEADING)
																								...
																								.addGroup(gl_abaAtualizarProduto.createParallelGroup(Alignment.TRAILING)
																									.addGroup(gl_abaAtualizarProduto.createSequentialGroup()
																										.addComponent(nomeNovoProduto_1_1_1, GroupLayout.PREFERRED_SIZE, 83, GroupLayout.PREFERRED_SIZE)
																										.addPreferredGap(ComponentPlacement.RELATED)
																										.addComponent(textField_5, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE)
																										.addGap(325))
																									.addGroup(gl_abaAtualizarProduto.createSequentialGroup()
																										.addComponent(nomeNovoProduto_1_1, GroupLayout.PREFERRED_SIZE, 83, GroupLayout.PREFERRED_SIZE)
																										.addPreferredGap(ComponentPlacement.RELATED)
																										.addGroup(gl_abaAtualizarProduto.createParallelGroup(Alignment.LEADING)
																											.addComponent(textField_4, GroupLayout.PREFERRED_SIZE, 390, GroupLayout.PREFERRED_SIZE)
																											.addComponent(btnAtualizar, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 197, GroupLayout.PREFERRED_SIZE))
																										.addGap(57))))
																							.addGap(55))
																				);
																				gl_abaAtualizarProduto.setVerticalGroup(
																					gl_abaAtualizarProduto.createParallelGroup(Alignment.TRAILING)
																						.addGroup(gl_abaAtualizarProduto.createSequentialGroup()
																							...
																							.addGroup(gl_abaAtualizarProduto.createParallelGroup(Alignment.BASELINE)
																								...
																								.addComponent(nomeNovoProduto_1_1_1)
		...
		gl_abaNovoPedido.setHorizontalGroup(
			gl_abaNovoPedido.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_abaNovoPedido.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_abaNovoPedido.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(Alignment.LEADING, gl_abaNovoPedido.createSequentialGroup()
							...
							.addGroup(gl_abaNovoPedido.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_abaNovoPedido.createSequentialGroup()
									...
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(textField_3, GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE))
								.addComponent(comboBox_1, Alignment.TRAILING, 0, 512, Short.MAX_VALUE)
								.addComponent(btnAdicionaNoCarrinho, Alignment.TRAILING)
								.addComponent(separator_1, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 512, Short.MAX_VALUE)
		...
		gl_abaNovoPedido.setVerticalGroup(
			gl_abaNovoPedido.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_abaNovoPedido.createSequentialGroup()
					.addContainerGap()
					...
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(btnAdicionaNoCarrinho)
					.addGap(44)
					...
					.addGap(12)
					.addComponent(carrinho, GroupLayout.PREFERRED_SIZE, 137, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addGroup(gl_abaNovoPedido.createParallelGroup(Alignment.BASELINE)
						.addComponent(btnFinalizaCompra)
						.addComponent(btnRemoveDoCarrinho))
		...
		gl_abaListaPedidos.setHorizontalGroup(
			gl_abaListaPedidos.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_abaListaPedidos.createSequentialGroup()
					.addGap(24)
					.addGroup(gl_abaListaPedidos.createParallelGroup(Alignment.LEADING)
		...
		gl_abaListaPedidos.setVerticalGroup(
			gl_abaListaPedidos.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_abaListaPedidos.createSequentialGroup()
					.addContainerGap()
					...
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(list_1, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
